...
VLEX is the attempt to overcome this SVG shortcomings. It is a damn small script (5 KB with a lot of comments; __750 bytes__ (!) minified and gzipped) that allows, once added to the SVG, a declarative layout.
